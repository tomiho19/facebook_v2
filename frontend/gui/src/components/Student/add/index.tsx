...
class RegistrationForm extends React.Component {
  ...
  sendValues = (values: any) => {
    ...
    // };
      ...
      console.log(values);
      // return;
      let previous_values = this.get_students_list();
      previous_values.push(values);
      this.set_student_list(previous_values);
      openNotificationWithIcon('success', 'Success', 'student has been successfully created');
    // //@ts-ignore
...
const AddNewStudent = Form.create({ name: 'register' })(RegistrationForm);
